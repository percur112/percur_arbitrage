import api_key = BinanceKey1['api_key']
import api_secret = BinanceKey1['api_secret']
...
def initialize_arb():
    ...
    welcome_message+="Percur"
    welcome_message+="\nCopyright by Fahim Ahamed\n"
...
def viz_arb_data(list_exch_rate_list, arb_market, start_time, end_time, Tweet_message='No', msg = ['Triangular Arbitrage Data']):
    ...
    host.set(title='Triangular Arbitrage - Exchange: {}\nStart: {} End: {}\n'
                   'Copyright @BlockchainDev'.format('Binance', start_time, end_time))
